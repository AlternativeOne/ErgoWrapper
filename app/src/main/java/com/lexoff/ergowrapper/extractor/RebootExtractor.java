...
public class RebootExtractor extends Extractor {
    private String PATH="xml_action.cgi?method=set";
    private String DATA="<?xml version=\"1.0\" encoding=\"US-ASCII\"?> <RGW><param><method>call</method><session>000</session><obj_path>router</obj_path><obj_method>router_call_reboot</obj_method></param></RGW>";

    public RebootExtractor(Client client){
        super(client, "");
