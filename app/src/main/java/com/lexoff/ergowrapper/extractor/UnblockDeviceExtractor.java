...
public class UnblockDeviceExtractor extends Extractor {
    private String PATH="xml_action.cgi?method=set";
    private String DATA="<?xml version=\"1.0\" encoding=\"US-ASCII\"?> <RGW><param><method>call</method><session>000</session><obj_path>statistics</obj_path><obj_method>unblock_clients</obj_method></param><statistics><clients_mac>%s</clients_mac></statistics></RGW>";

    public UnblockDeviceExtractor(Client client, String mac){
        super(client, "");
